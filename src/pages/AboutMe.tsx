      ...
      <section className="h-full space-y-10">
        ...
        <div className="text-center space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 mt-4">
            {[
              { name: "HTML", desc: "Marcação para construção de páginas web." },
              { name: "CSS", desc: "Estilização e responsividade para interfaces." },
              { name: "Bootstrap", desc: "Framework CSS para layouts responsivos." },
              { name: "TailwindCSS", desc: "Estilização com classes utilitárias." },
              { name: "React", desc: "Biblioteca para construção de interfaces reativas." },
              { name: "EJS", desc: "Template engine para renderização no servidor." },
              { name: "Node.js", desc: "Ambiente JavaScript para backend." },
              { name: "TypeScript", desc: "Superconjunto de JavaScript com tipagem estática." },
              { name: "Express.js", desc: "Framework web minimalista para Node.js." },
              { name: "Fastify", desc: "Framework backend rápido e eficiente." },
              { name: "MySQL", desc: "Banco de dados relacional." },
              { name: "PostgreSQL", desc: "Banco de dados SQL avançado e escalável." },
              { name: "MongoDB", desc: "Banco de dados NoSQL orientado a documentos." },
              { name: "Redis", desc: "Armazenamento em cache e mensagens assíncronas." },
              { name: "Prisma", desc: "ORM moderno e tipado para bancos de dados." },
              { name: "Knex", desc: "Query builder SQL para Node.js." },
              { name: "RabbitMQ", desc: "Mensageria para comunicação assíncrona." },
              { name: "BullMQ", desc: "Gerenciamento de filas de trabalhos assíncronos." },
              { name: "Docker", desc: "Conteinerização para ambientes isolados." },
              { name: "Linux", desc: "Sistema operacional para servidores." },
              { name: "Git & GitHub", desc: "Controle de versão e colaboração." },
              { name: "JWT & OAuth 2.0", desc: "Autenticação e segurança de APIs." },
            ].map((tech, index) => (
              <div key={index} className="flex flex-col items-center space-y-2">
                <div className="text-xl font-medium text-gray-300">{tech.name}</div>
          ...
          <h2 className="text-3xl font-semibold text-center">Experiência Freelancer</h2>

          <div className="border-t-2 border-gray-400 pt-4">
            <h3 className="text-xl font-semibold">Sistema de Cadastro para ONG Sidney Cardeira</h3>
          ...
          <div className="border-t-2 border-gray-400 pt-4">
            <h3 className="text-xl font-semibold">Sistema de Bingo Personalizado</h3>
            <p className="text-gray-300 font-light mt-2">
